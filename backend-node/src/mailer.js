            ...
            smtpTransport.sendMail(
              {
                ...
                to: email,
                subject: "souqarena: OTP for Verify Email",
                html:
                  "Dear user,<br><br> Thank you for registering with souqarena.<br> <br> <b> <strong>One Time OTP:</strong> " +
                  otp +
                ...
                // html:
                //   "Hi <br>" +
                //   "Your One Time Password(OTP) for completing your registeration on souqarena is  " +
                //   otp +
                //   " .Please do not share OTP with anyone .<br> Best Regards, <br> Team souqarena",
              },
              function (error, info) {
                if (error) {
                  return reject({
            ...
            smtpTransport.sendMail(
              {
                from: process.env.MAIL_FROM,
                to: email,
                subject: "souqarena: OTP Sent",
                html:
                  "Dear user,<br><br> Thank you for Reset Password with souqarena.<br> <br> <b> <strong>One Time OTP:</strong> " +
                  otp +
                  " </b><br> <br> This link will expire in 30sec. <br> This is a system generated mail. Please do not reply to this email ID.<br>Warm Regards,<br> Customer Care<br> souqarena",
                // html:
                //   "Hi <br>" +
