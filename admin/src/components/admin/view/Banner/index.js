                    ...
                    <div className="row">
                      <div className="col-lg-3 col-md-3">
                        <div className="form-group">
                          ...
                          >
                            <option value={0}>
                              Laptop(1280*350 height fixed)
                            </option>
                            <option value={1}>Mobile</option>
                            <option value={2}>Deals of the day(465*175)</option>
                            <option value={3}>Single slider(1280*280)</option>
                            <option value={4}>Another Category(465*175)</option>
                          </select>
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-3">
                          ...
                          ? list.map((row, index) => (
                              <tr key={index}>
                                ...
                                <td style={{ width: "100px" }}>
                                  <span
                                    className={row.type == "0" ? "" : "d-none"}
                                  >
                                    Laptop(1280*350 height fixed)
                                  </span>
                                  <span
                                    className={row.type == "1" ? "" : "d-none"}
                                  >
                                    Mobile
                                  </span>
                                  <span
                                    className={row.type == "2" ? "" : "d-none"}
                                  >
                                    Deals of the day(465*175)
                                  </span>
                                  <span
                                    className={row.type == "3" ? "" : "d-none"}
                                  >
                                    Single slider(1280*280)
                                  </span>
                                  <span
                                    className={row.type == "4" ? "" : "d-none"}
                                  >
                                    Another Category(465*175)
                                  </span>
                                </td>
                                <td>
                                  <span
